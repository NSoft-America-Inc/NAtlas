...
- **객관성과 사실성 준수**: 업무일지(`docs/noffice/`)를 작성할 때 "웅장한", "프리미엄", "완벽한", "100%", "완전무결한", "눈부신", "극적인" 등의 과장된 형용사나 미사여구를 일절 배제합니다.
- **담백한 사실 위주 서술**: 구현된 기능의 아키텍처, 적용된 기술 스택, 실제 테스트 통과 여부 및 차기 계획 등 객관적인 사실과 검증 결과만을 담백하게 기술합니다.
